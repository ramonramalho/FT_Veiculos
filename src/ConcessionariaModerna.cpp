...
ConcessionariaModerna::ConcessionariaModerna(string site, string facebook, string tweeter, string whatsapp,
        string nome, string endereco, string cidade, string estado, string telefone) : Concessionaria(nome, endereco, cidade, estado, telefone) {
